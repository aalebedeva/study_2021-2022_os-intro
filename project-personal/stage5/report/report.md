...
1. Сделать записи для персональных проектов. В данном случае проект по С++
...
3. Пишу и добавляю пост по выбору, а именно на тему: Языки научного программирования 
